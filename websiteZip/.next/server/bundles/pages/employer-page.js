...
// CONCATENATED MODULE: ./components/employer-page/hero.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
// CONCATENATED MODULE: ./components/employer-page/candidateDataBase.js
...
// CONCATENATED MODULE: ./components/employer-page/bestRecruiters.js
...
// CONCATENATED MODULE: ./components/employer-page/guaranteePlaced.js
...
// CONCATENATED MODULE: ./components/employer-page/testimonyCarousel.js
...
// CONCATENATED MODULE: ./components/employer-page/emailForm.js
...
// CONCATENATED MODULE: ./components/employer-page/contactSales.js
...
// CONCATENATED MODULE: ./pages/employer-page.js
function employer_page__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { employer_page__typeof = function _typeof(obj) { return typeof obj; }; } else { employer_page__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return employer_page__typeof(obj); }

function employer_page__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function employer_page__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function employer_page__createClass(Constructor, protoProps, staticProps) { if (protoProps) employer_page__defineProperties(Constructor.prototype, protoProps); if (staticProps) employer_page__defineProperties(Constructor, staticProps); return Constructor; }

function employer_page__possibleConstructorReturn(self, call) { if (call && (employer_page__typeof(call) === "object" || typeof call === "function")) { return call; } return employer_page__assertThisInitialized(self); }

function employer_page__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function employer_page__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var employer_page_EmployerPage =
/*#__PURE__*/
function (_Component) {
  employer_page__inherits(EmployerPage, _Component);

  function EmployerPage() {
    employer_page__classCallCheck(this, EmployerPage);

    return employer_page__possibleConstructorReturn(this, (EmployerPage.__proto__ || Object.getPrototypeOf(EmployerPage)).apply(this, arguments));
  }

  employer_page__createClass(EmployerPage, [{
    key: "render",
    value: function render() {
...
/* harmony default export */ var employer_page = __webpack_exports__["default"] = (Object(PageWrapper["a" /* default */])(employer_page_EmployerPage));
