...
// CONCATENATED MODULE: ./components/cannabis-jobseeker/list.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
// CONCATENATED MODULE: ./pages/cannabis-jobseeker.js
function cannabis_jobseeker__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { cannabis_jobseeker__typeof = function _typeof(obj) { return typeof obj; }; } else { cannabis_jobseeker__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return cannabis_jobseeker__typeof(obj); }

function cannabis_jobseeker__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function cannabis_jobseeker__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function cannabis_jobseeker__createClass(Constructor, protoProps, staticProps) { if (protoProps) cannabis_jobseeker__defineProperties(Constructor.prototype, protoProps); if (staticProps) cannabis_jobseeker__defineProperties(Constructor, staticProps); return Constructor; }

function cannabis_jobseeker__possibleConstructorReturn(self, call) { if (call && (cannabis_jobseeker__typeof(call) === "object" || typeof call === "function")) { return call; } return cannabis_jobseeker__assertThisInitialized(self); }

function cannabis_jobseeker__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function cannabis_jobseeker__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var url = "https://vangst.com/cannabis-jobseeker";
var title = "Vangst Job Seekers";
var description = "Vangst Cannabis Staffing's direct hire positions.";
var keywords = "mmj, marijuana horticulture, dispensary jobs, Weed Jobs, cannabis job";

var cannabis_jobseeker_DirectHire =
/*#__PURE__*/
function (_Component) {
  cannabis_jobseeker__inherits(DirectHire, _Component);

  function DirectHire() {
    cannabis_jobseeker__classCallCheck(this, DirectHire);

    return cannabis_jobseeker__possibleConstructorReturn(this, (DirectHire.__proto__ || Object.getPrototypeOf(DirectHire)).apply(this, arguments));
  }

  cannabis_jobseeker__createClass(DirectHire, [{
    key: "render",
    value: function render() {
      return external__react__default.a.createElement(Layout["a" /* default */], null, external__react__default.a.createElement(Header["a" /* default */], {
        ...
        keywords: keywords
      }), external__react__default.a.createElement(Menu["a" /* default */], null), external__react__default.a.createElement(list, null));
    }
  }]);
...
/* harmony default export */ var cannabis_jobseeker = __webpack_exports__["default"] = (Object(PageWrapper["a" /* default */])(cannabis_jobseeker_DirectHire));
