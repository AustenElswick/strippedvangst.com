            ...
            <div className="row justify-content-center align-items-center">
              <div className="col-lg-8">
                <div className="section-label">
                  <p className="section-number job-report-section-number">
                    .02
                  </p>
                ...
                <h2 className="text-left job-report-title">
                  Download the <br />
                  Vangst Salary Report
                </h2>
                <div className="white-line job-report-line" />
                <p className="section-copy job-report-section-copy">
                  The Vangst Cannabis Industry Salary Guide is the first-ever
                  report to establish the average salary of specific roles
                  within the cannabis industry. As the cannabis industry grows
                  at an exponential rate, we will continue to report the most
                  accurate and reliable data possible from leading companies.
                </p>
                <div className="white-line job-report-line" />
