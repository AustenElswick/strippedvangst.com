          ...
          <div className="row justify-content-left align-items-center">
            <div className="col-8 col-lg-7">
              ...
              <p className="text-dark section-copy">
                Vangst GIGS is the first and only fully compliant temporary
                employment service in cannabis. Vangst GIGS connects cannabis
                companies with temporary labor and allows cannabis temporary
                workers to build their own schedules and get paid quickly.
              </p>
              <div className="dark-line" />
              <div
                ...
                <a href="https://gigs.vangst.com/" target="_blank">
                  <div className="gigs-cta-button">
                    <div className="gigs-cta-text-container">
                      <p id="gigs-cta-text-1" className="gigs-cta-text">
                        Sign up for Vangst GIGS and get paid >
                      </p>
                      <p id="gigs-cta-text-2" className="gigs-cta-text">
                        Sign up >
                      </p>
                    </div>
                  </div>
